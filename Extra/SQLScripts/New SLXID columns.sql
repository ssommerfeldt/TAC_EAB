...
BEGIN TRANSACTION
GO
ALTER TABLE dbo.StgSOLine_TAC ADD
	SalesOrderID varchar(12) NULL,
	SalesOrderItemID varchar(12) NULL
GO
ALTER TABLE dbo.StgSOLine_TAC SET (LOCK_ESCALATION = TABLE)
GO
...
BEGIN TRANSACTION
GO
ALTER TABLE dbo.StgPOLine_TAC ADD
	SalesOrderID varchar(12) NULL,
	SalesOrderItemID varchar(12) NULL
GO
ALTER TABLE dbo.StgPOLine_TAC SET (LOCK_ESCALATION = TABLE)
GO
COMMIT
...
BEGIN TRANSACTION
GO
ALTER TABLE dbo.StgTrnsfrOrderLine_TAC ADD
	SalesOrderID varchar(12) NULL,
	SalesOrderItemID varchar(12) NULL
GO
ALTER TABLE dbo.StgTrnsfrOrderLine_TAC SET (LOCK_ESCALATION = TABLE)
GO
COMMIT
