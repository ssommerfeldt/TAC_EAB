...
Public Class SyncProducts : Inherits FX.SalesLogix.NetExtensionsHelper.SalesLogixDialog
    ...
    Function GetProductDataSet() As DataSet
        ...
        Try
            ...
            SQL = SQL & " Where SALESORDERID = '" & _SalesOrderId & "' and  QUANTITY <> 0"
    ...
    Sub DeleteAll_Products()
        ...
        Try
            ...
            Dim sql As String = "DELETE FROM SYSDBA.SALESORDERITEMS WHERE SALESORDERID ='" & _SalesOrderId & "'"
    ...
    Sub SetDisconnectedDataFlag(ByVal SalesOrderId As String, ByVal Flag As String)
        ...
        Try
            objConn.Open(SlxApplication.ConnectionString) ' Note Use the Native Client as we don't want to Sync This
            With objRS
