<%@ Control Language="C#" AutoEventWireup="true" CodeFile="QuoteSnapshot.ascx.cs" Inherits="QuoteSnapshot" %>
...
<div class="Bevel" style="width: 95%">
    ...
    <table id="tblDetails" runat="server" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr runat="server" id="rowDetailsHeader" class="snapshot-details-header" visible="false">
            ...
            <td>
                <asp:Label ID="lblQuoteHeader" runat="server" Text="<%$ resources: lblQuoteHeader.Caption %>"></asp:Label>
            </td>
            <td>
        ...
        <tr class="boldtext">
            <td id="Td1" runat="server" class="snapshot-column">
