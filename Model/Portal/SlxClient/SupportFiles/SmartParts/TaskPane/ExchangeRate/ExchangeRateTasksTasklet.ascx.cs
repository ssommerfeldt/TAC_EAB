...
public partial class SmartParts_TaskPane_ExchangeRateTasks_ExchangeRateTasksTasklet : UserControl, ISmartPartInfoProvider
{
    ...
    private IDictionary<string, string> GetTaskSecurityMap()
    {
        ...
        maps.Add("tskAddExchangeRate", "ENTITIES/EXCHANGERATE/ADD");
        return maps;
    }
    ...
    private void FillPageDictionaries()
    {
