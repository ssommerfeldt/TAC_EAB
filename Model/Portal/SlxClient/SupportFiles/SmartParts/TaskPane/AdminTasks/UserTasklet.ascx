...
<asp:UpdatePanel UpdateMode="Conditional" runat="server" ID="SAG">
    <ContentTemplate>
        ...
        <asp:Button runat="server" OnClick="tskAddUserToRole_Click" ID="tskAddUserToRole" CausesValidation="false" style="display:none;" ClientIDMode="Predictable" />
        <asp:Button runat="server" OnClick="tskResetUsers_Click" ID="tskResetUsers" CausesValidation="false" style="display:none;" ClientIDMode="Predictable" />

        <script type="text/javascript">
            var userTaskletActions;
            require(['Sage/TaskPane/UserTasklet', 'dojo/ready'],
                function (UserTasklet, ready) {
                    ready(function () {
