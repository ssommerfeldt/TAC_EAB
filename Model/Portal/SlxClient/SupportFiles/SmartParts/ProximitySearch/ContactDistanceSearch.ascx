<%@ Control Language="C#" Debug="true" AutoEventWireup="true" CodeFile="ContactDistanceSearch.ascx.cs"     Inherits="SmartParts_ProximitySearch_ContactDistanceSearch" %>
...
<div style="display:none">
	<SalesLogix:SmartPartToolsContainer ID="ContactDistanceSearch_RTools" runat="server">
	    <SalesLogix:PageLink ID="lnkContactDistanceSearchHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="Help"
	        NavigateUrl="contactdistancesearch" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16">
	    </SalesLogix:PageLink>
...
<script type="text/javascript">
    function scheduleActivity(activityType, entityId, entityDescription) {
        ...
        cec.setTemporaryContext({ EntityType: "Sage.Entity.Interfaces.IContact", EntityId: entityId, Description: entityDescription })
...
<table border="0" cellpadding="1" cellspacing="0" class="formtable">
    ...
    <tr>
        ...
        <td>
            ...
            <div class="textcontrol picklist">
                <SalesLogix:PickListControl runat="server" ID="pklType" PickListID="$qfcontrol.PickListId" MustExistInList="false" />
           </div>
        </td>
        <td>
    ...
    <tr>
        ...
        <td>
            <div class=" lbl alignleft">
                <asp:Label ID="pklStatusLbl" AssociatedControlID="pklStatus" runat="server" Text="Status"></asp:Label>
            </div>
            <div class="textcontrol picklist">
                <SalesLogix:PickListControl runat="server" ID="pklStatus" PickListName="Contact Status" MustExistInList="false" />
            </div>
        </td>
        <td>
...
<SalesLogix:SlxGridView runat="Server" ID="dgPostalCodeResults" GridLines="None"
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText = "Contact" SortExpression="NameLF">
            <itemTemplate>
       ...
       <asp:TemplateField HeaderText="Schedule" ItemStyle-Width="65" HeaderStyle-Width="65" ItemStyle-HorizontalAlign="Center">
          <itemTemplate> 
              <img title="Schedule Meeting" onclick='<%# GetScheduleLink("Meeting", (string)Eval("ContactId"), (string)Eval("NameLF")) %>' 
                src="images/icons/Schedule_Meeting_16x16.gif" class="schedulebtn" />
              <img title="Schedule Phone Call" onclick='<%# GetScheduleLink("PhoneCall", (string)Eval("ContactId"), (string)Eval("NameLF")) %>' 
                src="images/icons/Schedule_Call_16x16.gif"  class="schedulebtn"/>
              <img title="Schedule To Do" onclick='<%# GetScheduleLink("ToDo", (string)Eval("ContactId"), (string)Eval("NameLF")) %>'
                src="images/icons/Schdedule_To_Do_16x16.gif"  class="schedulebtn"/>
          </itemTemplate>
        </asp:TemplateField>
        
        <asp:BoundField HeaderText = "Address" SortExpression="Address1" DataField="Address1" />
