...
<div id="LiteratureRequestForm">
        ...
        <div class="twocoltextcontrol">
            <asp:TextBox data-dojo-type="Sage.UI.Controls.TextBox" runat="server" MaxLength="64" id="Description" />
        </div><br />
        <div class="col2">
        <div id="contactselection">
            <asp:Label ID="Label1" runat="server" meta:resourcekey="lblRequestFor" CssClass="lbl alignright" /><br />
        ...
        <br />
        <%-- Send options --%>
        <asp:Label CssClass="lbl alignright" runat="server" meta:resourcekey="SendBy_label" />
        ...
        <br />
        <div class="rightColInput">
            <input type="checkbox" ID="FulfillLocally"  class="inforCheckbox" />
            <label for="FulfillLocally" class="inforCheckboxLabel noColon label"><asp:Literal runat="server" meta:resourcekey="HandleFulfillmentLocally" Text="Handle fulfillment locally" /></label>
        </div>
        <asp:Label  CssClass="lbl alignright" runat="server" meta:resourcekey="SendVia_label" />
        ...
        <asp:Label CssClass="lbl alignright" runat="server" meta:resourcekey="Priority_label" />
        <div class="textcontrol picklist">
        ...
        <asp:Label ID="Label3" runat="server" meta:resourcekey="PrintLiteratureList_label"  CssClass="lbl alignright" /><br />
            <asp:RadioButtonList runat="server" ID="rblPrintLiteratureList" CssClass="rightColInput">
            ...
            <asp:Label runat="server" CssClass="lbl alignright" Text="<%$ Resources:CoverLetter %>" />
            <div class="textcontrol">
