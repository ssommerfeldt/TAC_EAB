...
require([
    ...
    ready(function () {
        ...
        declare("LitRequest.Sandbox", null, {
        ...
        declare("LitRequest.LiteratureRequestModel", null, {
            // summary:
        ...
        declare("LitRequest.Submission", null, {
            // summary:
        ...
        declare("LitRequest.LiteratureItemStore", [dojo.data.ItemFileWriteStore], {
            // summary:
        ...
        ///////// Contact Picker
        declare("LitRequest.ContactSelectionView", null, {
            _model: null,
            _formPrefix: null,
            ...
            _createContactLookup: function (formPrefix) {
                ...
                dojo.connect(btn, "onclick", function () {
                    var cols = [
                        {
                            label: LitrequestResources.Lookup_NameLF_PropertyHeader || 'Name',
                            field: 'FullName',
                        }, {
                            label: LitrequestResources.Lookup_Account_PropertyHeader || 'Account',
                            field: 'AccountName',
                        }, {
                            label: LitrequestResources.Lookup_City_PropertyHeader || 'City',
                            field: 'Address.City'
                        }, {
                            label: LitrequestResources.Lookup_State_PropertyHeader || 'State',
                            field: 'Address.State',
                        }, {
                            label: LitrequestResources.Lookup_Work_PropertyHeader || 'Phone',
                            field: 'WorkPhone',
                            type: Sage.UI.Controls.GridParts.Columns.Phone
                        }
                    ];
            ...
            _createOpportunityLookup: function (formPrefix) {
                ...
                dojo.connect(btn, "onclick", function () {
                    var cols = [
                    {
                        label: LitrequestResources.Lookup_Description_PropertyHeader || 'Description',
                        field: 'Description',
                    }, {
                        label: LitrequestResources.Lookup_Account_PropertyHeader || 'Account',
        ...
        declare("LitRequest.CoverLetterSelection", null, {
            // summary:
        ...
        declare("LitRequest.RequestParametersView", null, {
            // summary:
        ...
        declare("LitRequest.LiteratureItemSelectionView", null, {
        ...
        declare("LitRequest.ErrorModule", null, {
            // summary:
        ...
        declare("LitRequest.SubmissionProgressModule", null, {
            // summary:
            //  Progress bar module
        ...
        declare("LitRequest.ToolbarModule", null, {
            // summary:
        ...
        declare("LitRequest.LiteratureRequestForm", null, {
            constructor: function (formPrefix, options) {
                ...
                var descriptionField = dijit.byId('ContentPlaceHolderMain_MainContent_LiteratureRequest_Description');
        ...
        // Literature Grid
        declare("LitRequest.LiteratureGrid", [dijit._Widget, dijit._Templated], {
                ...
                this.store.fetch({
                    onComplete: function () {
                        ...
                        if (self.store.totalCount > 0) {
                            ...
                            dijit.byId('ContentPlaceHolderMain_MainContent_LiteratureRequest_Description').focus();
                        }
                    },
        ...
        declare("LitRequest.ItemFilter", [dijit._Widget, dijit._Templated], {
        ...
        declare("LitRequest.TemplatePicker", [dijit._Widget, dijit._Templated], {
            // summary:
            ...
            _openPopup: function () {
                var r = this;
                require(['Sage/MailMerge/Templates'], function (MailMergeTemplates) {
                    ready(function () {
                        var templates = new MailMergeTemplates();
