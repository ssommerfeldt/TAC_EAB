<%@ Control Language="C#" ClassName="AddTransferProducts" Inherits="Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider" %>
...
<tr>
 ...
 <div class=" lbl alignleft" >
   <asp:Label ID="ActualID_lbl" AssociatedControlID="ActualID" runat="server" Text="<%$ resources: ActualID.Caption %>" ></asp:Label>
 </div>
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="ActualID" Rows="1"
MaxLength="64"
AutoPostBack="true"  />
  </div>
...
AutoPostBack="true"  />
                ...
                <td  >
 <div class=" lbl alignleft" >
   <asp:Label ID="Price_lbl" AssociatedControlID="Price" runat="server" Text="<%$ resources: Price.Caption %>" Visible="false" ></asp:Label>
 </div>
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="Price" ReadOnly="true" Rows="1"
Visible="false"  />
  </div>
...
Visible="false"  />
                ...
                <td  >
 <div class=" lbl alignleft" >
   <asp:Label ID="Discount_lbl" AssociatedControlID="Discount" runat="server" Text="<%$ resources: Discount.Caption %>" Visible="false" ></asp:Label>
 </div>
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="Discount" ReadOnly="true" Rows="1"
Visible="false"  />
  </div>
...
<tr>
            <td></td>
                <td  >
 <div class=" lbl alignleft" >
   <asp:Label ID="ExtendedPrice_lbl" AssociatedControlID="ExtendedPrice" runat="server" Text="<%$ resources: ExtendedPrice.Caption %>" Visible="false" ></asp:Label>
 </div>
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="ExtendedPrice" ReadOnly="true" Rows="1"
Visible="false"  />
  </div>
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="AddTransferProducts_RTools" ToolbarLocation="right">
 ...
 AlternateText="<%$ resources: cmdSave.Caption %>"  ToolTip="<%$ resources: cmdSave.ToolTip %>" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Save_16x16"  />
  ...
  <SalesLogix:PageLink ID="lnkAddTransferProductsHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="AddTransferProducts" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
...
protected override void OnAddEntityBindings() {
        ...
        BindingSource.Bindings.Add(DescriptionTextBinding);
                    // ActualID.Text Binding
        Sage.Platform.WebPortal.Binding.WebEntityBinding ActualIDTextBinding = new Sage.Platform.WebPortal.Binding.WebEntityBinding("ActualID", ActualID, "Text");
        BindingSource.Bindings.Add(ActualIDTextBinding);
...
protected void ActualID_ChangeAction(object sender, EventArgs e) {
	//SKU onchange
	Sage.Entity.Interfaces.ISalesOrderItem _entity = BindingSource.Current as Sage.Entity.Interfaces.ISalesOrderItem;
    if (_entity != null) {
        object _parent = GetParentEntity();
...
ActualID.TextChanged += new EventHandler(ActualID_ChangeAction);
...
{
    get { return _formAdapter ?? (_formAdapter = new AddTransferProductsAdapter(this)); }
}

public class AddTransferProductsAdapter : Sage.Platform.WebPortal.Adapters.EntityFormAdapter, Sage.Form.Interfaces.IAddTransferProducts
{
    public AddTransferProductsAdapter(Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider smartPart)
        : base(smartPart) {}
    ...
    private Sage.Platform.Controls.ITextBoxControl _ActualID;
    public  Sage.Platform.Controls.ITextBoxControl ActualID
    {
        get { return FindControl(ref _ActualID, "ActualID"); }
    }
    ...
    private Sage.Platform.Controls.ITextBoxControl _ExtendedPrice;
    public  Sage.Platform.Controls.ITextBoxControl ExtendedPrice
    {
