...
<table class="formtable">
         ...
         <td colspan="2">
            <div class="textcontrol lookup">
                <SalesLogix:LookupControl runat="server" ID="lueTargetAccount" LookupEntityName="Account" EnableHyperLinking="false"
                    ...
                    <LookupProperties>
                        <SalesLogix:LookupProperty PropertyHeader="<%$ resources:AccountName.PropertyHeader %>" PropertyName="AccountName" PropertyFormat="None" PropertyType="System.String"
                            UseAsResult="True">
                        </SalesLogix:LookupProperty>
                        <SalesLogix:LookupProperty PropertyHeader="<%$ resources:MainPhone.PropertyHeader %>" PropertyName="MainPhone" PropertyFormat="Phone" PropertyType="System.String"
                            UseAsResult="True">
                        </SalesLogix:LookupProperty>
                        <SalesLogix:LookupProperty PropertyHeader="<%$ resources:Type.PropertyHeader %>" PropertyName="Type" PropertyFormat="None" PropertyType="System.String"
                            UseAsResult="True">
                        </SalesLogix:LookupProperty>
                        <SalesLogix:LookupProperty PropertyHeader="<%$ resources:SubType.PropertyHeader %>" PropertyName="SubType" PropertyFormat="None" PropertyType="System.String"
                            UseAsResult="True">
                        </SalesLogix:LookupProperty>
                        <SalesLogix:LookupProperty PropertyHeader="<%$ resources:Status.PropertyHeader %>" PropertyName="Status" PropertyFormat="None" PropertyType="System.String"
                            UseAsResult="True">
                        </SalesLogix:LookupProperty>
                    </LookupProperties>
                    <LookupPreFilters>
    ...
    <tr>
        <td colspan="3">
            <div class="lblright checkbox" style="padding-left: 10px">
                <asp:CheckBox ID="chkAssociateWithSource" runat="server" Text="<%$ resources:chkAssociateWithSource.Text %>" CssClass="inforAspCheckBox" />
            </div>
        </td>
    </tr>
    <tr>
        <td colspan="3">
            <div class="lblright checkbox" style="padding-left: 10px">
                <asp:CheckBox ID="chkUseTargetAddressPhn" runat="server" Text="<%$ resources:chkUseTargetAddressPhn.Text %>" Checked="True" CssClass="inforAspCheckBox"/>
            </div>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td>
            <div class="lblright checkbox" style="padding-left: 10px">
                <asp:CheckBox ID="chkCopyActivities" runat="server" Text="<% $resources:chkCopyActivities.Text %>" CssClass="inforAspCheckBox"/>
            </div>
        </td>
        <td colspan="2">
            <div class="lblright checkbox" style="padding-left: 10px">
                <asp:CheckBox ID="chkCopyNotes" runat="server" Text="<%$ resources:chkCopyNotes.Text %>" CssClass="inforAspCheckBox"/>
            </div>
        </td>
    </tr>
    <tr>
        <td>
            <div class="lblright checkbox" style="padding-left: 10px">
                <asp:CheckBox ID="chkCopyHistory" runat="server" Text="<%$ resources:chkCopyHistory.Text %>" CssClass="inforAspCheckBox"/>
            </div>
        </td>
    </tr>
</table>
