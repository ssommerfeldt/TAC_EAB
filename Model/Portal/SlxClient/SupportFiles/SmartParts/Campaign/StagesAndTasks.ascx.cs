    ...
    private void LoadGrid()
    {
        using (new SessionScopeWrapper(true))
        {
            ...
            grdStages.DataSource = Sage.SalesLogix.Campaign.Rules.GetStageAndTasks(campaign,
                grdStages.CurrentSortExpression,
                grdStages.CurrentSortDirection.Equals("Ascending", StringComparison.OrdinalIgnoreCase));
            grdStages.DataBind();
        }
    }

    protected void grdStages_Sorting(object sender, GridViewSortEventArgs e)
    {
