...
public partial class SmartParts_TACPrintPackingList : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        //this takes request parameters only from the query string
        string pickinglistid = Request.QueryString["pickinglistid"];
        ...
        else
        {
            ...
            try
            {
                Sage.Entity.Interfaces.IPickingList  pickinglist = Sage.Platform.EntityFactory.GetById<Sage.Entity.Interfaces.IPickingList>(pickinglistid );


                string reportPath = Server.MapPath("CrystalReports\\PackingListDetail.rpt");
                ...
                crReport.RecordSelectionFormula = "{PICKINGLIST.PICKINGLISTID} = '" + pickinglist.Id.ToString() + "'";
                ...
                String filename = "exportedPDF/PackingList" + pickinglist.Id.ToString()+ ".pdf";
