define("Sage/Library/nls/FileHandler", {
    root: {
        ...
        No: 'No',
        NoAccessMessage: 'You do not have permission to add files to the Library. For more information contact your Infor CRM administrator.',
        Ordered: 'Ordered',
