...
function (_Widget, _Templated, ValidationTextBox, regexp, TextBox, declare, Utility) {
    ...
    var widget = declare("Sage.UI.URL", [_Widget, _Templated], {
        ...
        widgetTemplate: new Simplate([
            ...
            '{% } %}',
            '{% if ($.disabled !== "disabled") { %} ',
            ' dojoAttachEvent="onChange:formatURLChange, onDblClick:launchWebSite, regExpGen:regExpGen" ',
            '{% } %}',
            ' tabindex="{%= $.tabIndex %}" ',
        ...
        regExpGen: function() {
            return Utility.regexp.invalidInput;
        },
        formatURL: function () {
