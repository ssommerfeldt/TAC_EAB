...
function (controlsNumeric, dijitCell, declare, lang) {
    var widget = declare("Sage.UI.Columns.Numeric", dojox.grid.cells._Widget, {
        ...
        getValue: function (index) {
            ...
            if (this.formatType == 'Percent') {
                // Ensure _onBlur fires so the value is converted back from a whole number to a decimal.
                // Chrome has a wierd timing issue here if we don't call it directly.
                this.widget.focusNode._onBlur();
            }
