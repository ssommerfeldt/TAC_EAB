define("Sage/UI/Dashboard/nls/WidgetDefinition", {
    root: {
        ...
        Welcome_Description: 'Displays an introduction to Infor CRM with a link to the help topic Introducing Infor CRM for Web.',
        ...
        Links_Description: 'Displays links you create. For example, to a detail view in Infor CRM or to an external Web site.',
        SData_Feed_Description: 'Displays a web feed using SData (Sage Data) feeds. For example, a feed from your accounting integration or Infor CRM database.',
