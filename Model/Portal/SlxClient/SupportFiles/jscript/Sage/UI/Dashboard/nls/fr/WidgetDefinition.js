define("Sage/UI/Dashboard/nls/fr/WidgetDefinition", {
    ...
    "Welcome_Description": "Affiche une introduction à Saleslogix avec un lien vers la rubrique d'aide Introduction à Saleslogix pour le Web.",
    ...
    "Bar_Chart_Description": "Affiche des données sous la forme de barres horizontales. Ceci est utile pour comparer plusieurs ensembles de données.",
    "Column_Chart_Description": "Affiche des données sous la forme de barres verticales regroupées par catégorie. Ceci est utile pour afficher les modifications effectuées sur les données pendant une période de temps donnée ou pour illustrer les comparaisons entre des éléments.",
    ...
    "Recently_Viewed_Description": "Affiche les liens vers les enregistrements récemment consultés, dont le type est indiqué par une icône. Par exemple, un compte ou un contact.",
    ...
    "SData_Feed_Description": "Affiche un flux Web dans les flux SData (Sage Data). Par exemple, un flux de votre base de données Saleslogix ou de l'intégration de comptabilité.",
