...
define("Sage/UI/Filters/EntityManagerFilterPanel", [
    'dijit/_Widget',
    'dijit/_Container',
    'Sage/_Templated',
    ...
    var filterPanel = declare('Sage.UI.Filters.EntityManagerFilterPanel', [_Widget, _Container, _ServiceMixin, _Templated], {
        ...
        widgetTemplate: new Simplate([
            '<div class="filter-panel" data-dojo-attach-point="containerNode">',
                '<div class="filter-edit"><span class="activity-type-link" data-dojo-attach-point="clearAllFiltersNode">{%= $.clearText %}</span> | <span class="activity-type-link" data-dojo-attach-point="editFiltersNode">{%= $.editText %}</span></div>',
