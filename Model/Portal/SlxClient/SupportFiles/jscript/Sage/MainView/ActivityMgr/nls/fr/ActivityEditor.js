define("Sage/MainView/ActivityMgr/nls/fr/ActivityEditor", {
    ...
    "tabNameRecurringText": "Récurrent",
    ...
    "addResourceText": "Ajouter la sélection",
    ...
    "failedLoadingDataMsg": "Une erreur s'est produite lors du chargement des données.",
    "removeText": "Supprimer",
    "noText": "Non",
    "yesText": "Oui",
    "areYouSureText": "Vous êtes sur le point de supprimer définitivement cet enregistrement.",
    "couldNotSaveErrorText": "Impossible d'enregistrer l'activité car une erreur s'est produite.",
    ...
    "scheduleFollowUpErrorText": "Impossible de planifier le suivi, car l'HistoryId n'a pas pu être déterminé.",
