...
define("Sage/MainView/EntityMgr/EntityManagerGroupContextService", [
...
function(
    ...
    var entityManagerGroupContextService = declare('Sage.MainView.EntityMgr.EntityManagerGroupContextService', BaseGroupContextService, {
        ...
        staticTabsConfiguration: [
            {
                key: 'entity',
                descriptor: nlsResources.entityTabDisplayName,
                keyField: "$key",
        ...
        constructor: function() {
            ...
            this._subscribes.push(
                connect.subscribe(dojoString.substitute("/ui/filters/default/refresh"), this, this._onDefaultFilterRefresh)
            );
        ...
        _clearFilterManager: function() {
            connect.publish('/ui/filters/default/apply', [{}, {}, this]);
        },
        ...
        _requestFilters: function(onSuccessCallBack) {
            ...
            var optionsSvc = new UserOptions();
        ...
        _onDefaultFilterRefresh: function(applied, definitionSet, filterManager) {
            var filter = json.toJson(filterManager.createEntityManagerValueSet());
            var optionsSvc = new UserOptions();
            if (optionsSvc) {
