...
define("Sage/MainView/EntityMgr/EntityFilterConfigurationProvider", [
...
function (
    ...
    var filterConfigurationProvider = declare('Sage.MainView.EntityMgr.EntityFilterConfigurationProvider', [_ConfigurationProvider, _ServiceMixin], {
        _configuration: null,
        ...
        constructor: function (options) {
            ...
            if (this.groupContextService.declaredClass !== 'Sage.MainView.EntityMgr.EntityManagerGroupContextService') {
                Sage.Services.removeService('ClientGroupContext');
                this.groupContextService = new EntityManagerGroupContextService();
