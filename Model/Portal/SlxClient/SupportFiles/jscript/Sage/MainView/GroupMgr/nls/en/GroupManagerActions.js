define("Sage/MainView/GroupMgr/nls/en/GroupManagerActions", {
    ...
    UserName: 'User Name',
    Type: 'Type',
	ConfirmDeletionMsgSelectedGroups: 'Are you sure you want to delete the selected group(s) (including shares)?',
	ConfirmResetMsgSelectedStatics: 'Are you sure you want to reset the selected group statistics?',
	ConfirmDeletionMsgSelectedReleases: 'Are you sure you want to delete the selected shared group(s)?'
});