define("Sage/TaskPane/nls/fr/ContactTasksTasklet", {
    "associateContactTitle": "Associer à l'utilisateur",
    "disAssociateContactTitle": "Dissocier de l'utilisateur",
    "disAssociateDialogTitle": "Dissocier d'un utilisateur",
    "confirmDisAssociate": "Voulez-vous vraiment dissocier ${0} contact(s) sélectionné(s) d'un utilisateur associé ?",
    "confirmDisAssociateMultiple": "Voulez-vous vraiment dissocier les ${0} contacts sélectionnés de tous les utilisateurs associés ?",
    "associationExistsMessage": "Le contact sélectionné est déjà associé à un utilisateur. Pour associer ce contact à un autre utilisateur, vous devez tout d'abord dissocier le contact de l'utilisateur.",
