...
define("Sage/TaskPane/EntityManagerTasklet", [
        'dijit/_Widget',
        'dijit/_Container',
        'Sage/_Templated',
...
function (
   ...
   declare
    ...
    var entityManagerTasklet = declare('Sage.TaskPane.EntityManagerTasklet', [_Widget, _Container, _ServiceMixin, _Templated], {
        serviceMap: {
        ...
        widgetTemplate: new Simplate([
             '<div class="entityTask-panel"  dojoAttachPoint="containerNode">',
            '</div>'
        ]),
        _configuration: null,
