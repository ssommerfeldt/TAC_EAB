...
define("Sage/TaskPane/User/ContactUserAssociationEditor", [
        'dojo/_base/declare',
    ...
    var contactUserAssociationEditor = declare('Sage.TaskPane.User.ContactUserAssociationEditor', [_Widget, _Templated], {
        ...
        createContactLookup: function () {
            this.contactLookupConfig = {
                ...
                structure: [
                    {
                        "label": this.lookupFirstNameColText,
                        "field": 'FirstName',
                        "sortable": true
                    },{
                        "label": this.lookupLastNameColText,
                        "field": 'LastName',
                        "sortable": true
                    }, {
                        ...
                        "label": this.lookupAccountColText,
                        "field": 'AccountName',
                        "sortable": true
                    }, {
                        "label": this.lookupWorkPhoneColText,
                        "field": 'WorkPhone',
                        "sortable": true
                    }, {
                        "label": this.lookupEmailText,
                        "field": 'Email',
                        "sortable": true
                    }                           
                ],
