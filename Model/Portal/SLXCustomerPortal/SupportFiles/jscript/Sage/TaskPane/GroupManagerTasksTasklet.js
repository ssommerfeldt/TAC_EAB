...
define("Sage/TaskPane/GroupManagerTasksTasklet", [
        'dojo/_base/declare',
        ...
        **/
            _getGroupsTasks: function() {
                var taskItems = [
                    ...
                    {
                        taskId: 'taskToggleUserDefault',
                        type: 'Link',
                        displayName: nlsResources.txtToggleUserDefault,
                        clientAction: 'Sage.MainView.GroupMgr.GroupManagerActions.toggleUserDefault();',
                        securedAction: 'Administration/GroupManager/Groups/ToggleUserDefault'
                    }
                ];
                return taskItems;
            },
