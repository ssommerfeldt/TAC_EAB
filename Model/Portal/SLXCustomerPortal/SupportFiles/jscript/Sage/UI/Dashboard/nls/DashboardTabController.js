define("Sage/UI/Dashboard/nls/DashboardTabController", {
    root: {
        ...
        invalidReservedWordMessage: 'Dashboard is reserved tab name. Please change the name before continuing.',
        deleteText: 'Delete',
        titleText: 'Title:',
        ...
        yesText: 'Yes',
        noText: 'No',
        DeletingReleasedWidget: 'Are you sure you want to delete this Dashboard tab?  This tab is shared with ${0} user(s).  Deleting this tab will delete it for all users.',
        Welcome: 'Welcome',
        Dashboard: 'Dashboard'
    },
    "en": true,
