...
define("Sage/MainView/Import/ImportWizardController", [
    'dojo/_base/declare',
    'dojo/string',
    'dojo/_base/array',
...
function (
    ...
    var importWizard = declare('Sage.MainView.Import.ImportWizardController', [wizardDialogBase], {
        ...
        */
        constructor: function (entity, entityDisplayName, entityType) {
            this._initializeImportOptions(entity, entityDisplayName, entityType);
        ...
        _initializeImportOptions: function (entity, entityDisplayName, entityType) {
            this.importOptions.isInitialized = false;
            this.importOptions.importEntity = entity;
            this.importOptions.importEntityDisplayName = entityDisplayName;
        ...
        _assignDefaultAdHocGroupName: function () {
            ...
            if (clientContextSvc) {
                ...
                var dateStamp = dojo.date.locale.format(new Date(), { datePattern: dojoString.substitute("${0} h:mm:ss", [dateFormat]), locale: Sys.CultureInfo.CurrentCulture.name });
