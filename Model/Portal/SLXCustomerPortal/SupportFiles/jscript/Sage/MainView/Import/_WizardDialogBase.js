...
define("Sage/MainView/Import/_WizardDialogBase", [
    'dojo/_base/declare',
    'dojo/_base/array',
    'dojo/topic',
    'dojo/_base/lang',
...
function (
    ...
    var wizardDialogBase = declare('Sage.MainView.Import._WizardDialogBase', [widget, templated], {
        ...
        */
        ...
        /*
            Default implementation for data validation.  Do not delete required by classes that inherit from _WizardDialogBase.
            child implementation is responsible for calling success and failed callbacks as part of their validation code
        */
        ...
        _commonConfigurationOptions: function () {
            return {
                ...
                importEntityDisplayName: this.importOptions.importEntityDisplayName,
                ...
                buildSecondaryAccountName: this.importOptions.buildSecondaryAccountName
            };
        },
        getTargetProperty: function(targetItem, targetProperty, searchProperty, searchValue) {
            var target = {
                ...
                visableToUsers: targetItem.visableToUsers
            };
        ...
        */
        ...
        _btnNext_OnClick: function () {
            this.preformValidation(this._validationSuceeded.bind(this), this._validationFailed.bind(this));
        },
        _validationSuceeded: function () {
            this._checkCurrentStep();
            this._dialog.hide();
