...
define("Sage/MainView/ReportMgr/SchedulesSDataDetailViewDataManager", [
...
function (sDataServiceRegistry, SDataStore, declare, lang) {
    var schedulesSDataDetailRequestQueue = declare('Sage.MainView.ReportMgr.SchedulesSDataDetailRequestQueue', null, {
        select: [],
        resourceKind: '',
        fetching: false,
        include: [],
    ...
    var schedulesSDataSummaryViewDataManager = declare('Sage.MainView.ReportMgr.SchedulesSDataDetailViewDataManager', null, {
        keyField: "$key",
        constructor: function () {
            this.queue = new schedulesSDataDetailRequestQueue();
            this.requestTimeout = false;
        },
        requestDataNoWait: function (entityid, widget, requestConfiguration) {
            var tempQueue = new schedulesSDataDetailRequestQueue();
    ...
    return schedulesSDataSummaryViewDataManager;
});