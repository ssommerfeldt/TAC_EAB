...
define("Sage/MainView/ReportMgr/Crystal/CrystalReportsUtility", [
    'dojo/date/locale',
    ...
    dojo.mixin(Sage.MainView.ReportMgr.Crystal.CrystalReportsUtility, {
        ...
        */
        ...
        getDateOnlyFormattedDate: function (dateValue) {
            return locale.format(dateValue, { selector: 'date', fullYear: true, locale: Sys.CultureInfo.CurrentCulture.name });
        },
