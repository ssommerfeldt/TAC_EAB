define("Sage/MainView/ReportMgr/Crystal/nls/fr/_ParameterEditorBase", {
    ...
    "lblEnterValue_Caption": "Saisir une valeur :",
    "btnOK_Caption": "OK",
    "txtTheValueMustBeBetween": "La valeur doit contenir entre {0} et {1} caractères.",
    "txtTheMinimumLengthForThisField": "La longueur minimale pour ce champ est {0}.",
    "txtTheMaximumLengthForThisField": "La longueur maximale pour ce champ est {0}.",
    ...
    "txtFrom": "De :",
    "txtTo": "A :",
    "txtPleaseSpecifyFromValue": "Veuillez spécifier une valeur pour la plage de début",
    "txtPleaseSpecifyToValue": "Veuillez spécifier une valeur pour la plage de fin",
