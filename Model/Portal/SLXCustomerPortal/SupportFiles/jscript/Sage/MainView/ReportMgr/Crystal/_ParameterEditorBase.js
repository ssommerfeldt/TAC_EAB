...
define("Sage/MainView/ReportMgr/Crystal/_ParameterEditorBase", [
    'dojo/_base/declare',
    'dojo/_base/array',
    'dojo/number',
    'dijit/_Widget',
    ...
    var _parameterEditorBase = declare('Sage.MainView.ReportMgr.Crystal._ParameterEditorBase', [_Widget, _Templated], {
        ...
        */
        ...
        _initializeParameterProperties: function () {
            ...
            // Handle when the initialValues is populated but the values and defaultValues are not.
            if (this._promptParameter.initialValues !== null &&
                this._promptParameter.initialValues.length > 0 &&
                this._promptParameter.values === null &&
                this._promptParameter.defaultValues === null) {
                this._promptParameter.values = this._promptParameter.initialValues;
        ...
        _formatDateTimeDescription: function (dateTime) {
            if(this._promptParameter.parameterValueKind === enumerations.SlxParameterValueKind.DateTimeParameter && this._promptParameter.defaultValueDisplayType === 'Description')
                return dateTime;
            if (this._promptParameter.parameterValueKind === enumerations.SlxParameterValueKind.DateTimeParameter) {
                return locale.format(utility.Convert.toDateFromString(dateTime, false), { fullYear: true, locale: Sys.CultureInfo.CurrentCulture.name });
            } else {
                return locale.format(utility.Convert.toDateFromString(dateTime, false), { fullYear: true, selector: this.displayTime ? null : 'date', locale: Sys.CultureInfo.CurrentCulture.name });
            }
        },
