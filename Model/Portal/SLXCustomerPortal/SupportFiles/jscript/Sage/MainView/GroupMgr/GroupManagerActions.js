...
define("Sage/MainView/GroupMgr/GroupManagerActions", [
        'dojo/_base/declare',
        'dojo/_base/lang',
        'Sage/UI/Dialogs',
        ...
        dojo.mixin(Sage.MainView.GroupMgr.GroupManagerActions, {
            ...
            _delete: function (deleteKind) {
                ...
                if (panel) {
                    ...
                    if (selectionInfo && selectionInfo.selectionCount >= 1) {
                        var serviceName, resourceKind, resourceSelectorPrefix, txtDisplay;
                        switch (deleteKind) {
                            case this.DeleteKind.Group:
                                ...
                                txtDisplay = nlsResources.ConfirmDeletionMsgSelectedGroups;
                                break;
                            case this.DeleteKind.Release:
                                serviceName = 'system';
                                resourceKind = 'groups';
                                resourceSelectorPrefix = null;
                                txtDisplay = nlsResources.ConfirmDeletionMsgSelectedReleases;
                                break;
                            case this.DeleteKind.Statistics:
                                serviceName = 'dynamic';
                                resourceKind = 'groupStatistics';
                                resourceSelectorPrefix = 'PluginId eq ';
                                txtDisplay = nlsResources.ConfirmResetMsgSelectedStatics;
                                break;
                            default:
                                return;
                        }
            ...
            _toggleUserDefault: function (selectionInfo) {
                var service = sDataServiceRegistry.getSDataService('system');
                var request = new Sage.SData.Client.SDataServiceOperationRequest(service);
                var operation = 'toggleUserDefault';
            ...
            toggleUserDefault: function () {
                ...
                if (panel) {
                    ...
                    if (selectionInfo && selectionInfo.selectionCount >= 1) {
                        ...
                        this._toggleUserDefault(selectionInfo);
                    } else {
                        dialogs.showInfo(nlsResources.SelectRecordMsg);
                    }
                }
