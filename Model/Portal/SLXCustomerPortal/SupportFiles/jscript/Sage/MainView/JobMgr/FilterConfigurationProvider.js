...
function (
    ...
    var filterConfigurationProvider = declare('Sage.MainView.JobMgr.FilterConfigurationProvider', [_ConfigurationProvider, _ServiceMixin], {
        _configuration: null,
        ...
        constructor: function (options) {
            ...
            if (this.groupContextService.declaredClass !== 'Sage.MainView.JobMgr.JobManagerGroupContextService') {
