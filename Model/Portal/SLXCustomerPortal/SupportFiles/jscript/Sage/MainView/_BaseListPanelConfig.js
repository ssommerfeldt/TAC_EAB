...
define("Sage/MainView/_BaseListPanelConfig", [
    ...
    var _baseListPanelConfig = declare('Sage.MainView._BaseListPanelConfig', [_ConfigurationProvider], {
        ...
        _getListConfig: function () {
            ...
            var listConfig = {
                ...
                store: this._store,
                defaultSelectFirst: this.defaultSelectFirst,
