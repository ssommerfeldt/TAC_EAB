...
'Sage/TaskPane/User/nls/fr-be/ContactUserAssociationEditor':function(){
define('Sage/TaskPane/User/nls/fr-be/ContactUserAssociationEditor',{});
},
...
'Sage/Services/nls/fr-be/JobService':function(){
define('Sage/Services/nls/fr-be/JobService',{});
},
...
{ errFulFillmentCancelled: 'La réalisation de la demande de documentation a été annulée pour IdDemDoc {0}.',
  errFulFillmentFailed: 'La demande de documentation a pas pu être complétée pour IdDemDoc {0}.',
  errMailMergeService: 'étape de processus de vente a pas pu être achevée car le service de publipostage a pas pu être chargé. Cela peut se produire si intégration de bureau Sage SalesLogix est pas installée ou est installée de manière incorrecte.',
  errFulFillmentRequest: 'Les demandes de documentation ont pas pu être complétées.',
  errFulFillmentRequestEx: 'Les demandes de documentation suivantes ont pas pu être complétées :',
...
'Sage/MainView/ReportMgr/nls/fr-be/ReportManagerFormatter':function(){
define('Sage/MainView/ReportMgr/nls/fr-be/ReportManagerFormatter',{});
},
...
'Sage/MainView/ActivityMgr/AttendeeLookup/nls/fr-be/SpeedSearchLookup':function(){
define('Sage/MainView/ActivityMgr/AttendeeLookup/nls/fr-be/SpeedSearchLookup',{});
},
...
{ defaultWidgetText: 'Modifier les paramètres du build',
  ...
  Column_Chart_Description: 'Affiche des données sous la forme ensemble de barres verticales regroupées par catégorie. Ceci est utile pour afficher les modifications qui ont affecté les données pendant une période de temps donnée ou pour illustrer les comparaisons entre des éléments.',
  Funnel_Chart_Description: 'Affiche les données en tant que proportions progressives sous la forme d’un entonnoir. Les données sont représentées en pourcentages et il n’y a pas axe.',
  ...
  SData_Feed_Description: 'Affiche un flux Web dans les flux SData (Sage Data). Par exemple, un flux de votre base de données Saleslogix ou de intégration de comptabilité.',
...
'Sage/MainView/JobMgr/nls/fr-be/JobManagerActions':function(){
define('Sage/MainView/JobMgr/nls/fr-be/JobManagerActions',{});
},
...
'Sage/MainView/ActivityMgr/AttendeeLookup/nls/fr-be/ContactLookupConfig':function(){
define('Sage/MainView/ActivityMgr/AttendeeLookup/nls/fr-be/ContactLookupConfig',{});
},
...
'Sage/Library/nls/fr-be/Manager':function(){
define('Sage/Library/nls/fr-be/Manager',{});
},
...
'Sage/MainView/JobMgr/nls/fr-be/ExecutionsListPanelConfig':function(){
define('Sage/MainView/JobMgr/nls/fr-be/ExecutionsListPanelConfig',{});
},
...
{ AccessError: "Votre rôle ne vous permet pas exécuter cette action.",
  ...
  DocumentUpdateConflictError: "Le fichier a été mis à jour par un autre utilisateur. Veuillez actualiser et réessayer.",
  FileDeleteError: "Une erreur inattendue est survenue lors de la tentative de suppression un fichier.",
  FileStatusError: "Une erreur inattendue est survenue pendant la tentative de mise à jour de état du fichier.",
  ...
  No: 'Non',
  NoAccessMessage: "Vous avez pas autorisation ajouter des fichiers à la bibliothèque. Contactez votre administrateur Sage SalesLogix pour obtenir des informations supplémentaires.",
  Ordered: 'Commandé',
  PleaseSelectFile: 'Veuillez sélectionner un fichier.',
  PleaseWait: 'Veuillez patienter',
  Revised: 'Révisé',
  RevisionOrdered: 'Révision commandée',
  UploadError: "Une erreur est survenue pendant la tentative de téléchargement un fichier.",
  Unknown: 'Inconnu',
  Yes: 'Oui' }
));
},
'Sage/Library/nls/fr-be/FileHandler':function(){
define('Sage/Library/nls/fr-be/FileHandler',{});
},
...
'Sage/Utility/nls/fr-be/Sql':function(){
define('Sage/Utility/nls/fr-be/Sql',{});
},
...
'Sage/MainView/JobMgr/nls/fr-be/RunJobDialog':function(){
define('Sage/MainView/JobMgr/nls/fr-be/RunJobDialog',{});
},
...
'Sage/Extensions/Activity/ActivityListCustomTabs/nls/fr/SyncedListPanelConfig':function(){
define('Sage/Extensions/Activity/ActivityListCustomTabs/nls/fr/SyncedListPanelConfig',{});
},
'Sage/Extensions/Activity/ActivityListCustomTabs/nls/fr-be/SyncedListPanelConfig':function(){
define('Sage/Extensions/Activity/ActivityListCustomTabs/nls/fr-be/SyncedListPanelConfig',{});
},
...
'Sage/MainView/ReportMgr/Crystal/nls/fr-be/CrystalReportsFormatter':function(){
define('Sage/MainView/ReportMgr/Crystal/nls/fr-be/CrystalReportsFormatter',{});
},
'Sage/Utility/File/nls/fr/DragDropWatcher':function(){
define("Sage/Utility/File/nls/fr/DragDropWatcher", (
{ query0: 'La fonctionnalité que vous demandez requiert installation du module intégration de bureau <br> Saleslogix.',
  query1: 'En savoir plus...',
  query2: 'Voulez-vous installer cette fonctionnalité maintenant ?',
  query3: 'Remarque : le module peut être installé à tout moment à partir des pages de connexion ou options.' }
));
},
...
'Sage/Extensions/Activity/ListPanelOverrides/nls/fr-be/AllOpenListPanelConfig':function(){
define('Sage/Extensions/Activity/ListPanelOverrides/nls/fr-be/AllOpenListPanelConfig',{});
},
...
'Sage/MainView/ReportMgr/Crystal/nls/fr-be/MultiselectNumberParameterEditor':function(){
define('Sage/MainView/ReportMgr/Crystal/nls/fr-be/MultiselectNumberParameterEditor',{});
},
...
'Sage/MainView/ReportMgr/Common/nls/fr-be/ExportOptionsDialog':function(){
define('Sage/MainView/ReportMgr/Common/nls/fr-be/ExportOptionsDialog',{});
},
...
'Sage/UI/nls/fr-be/EditCalendarUsers':function(){
define('Sage/UI/nls/fr-be/EditCalendarUsers',{});
},
...
'Sage/MainView/ReportMgr/Crystal/nls/fr-be/CrystalReportParametersDialog':function(){
define('Sage/MainView/ReportMgr/Crystal/nls/fr-be/CrystalReportParametersDialog',{});
},
...
'Sage/MainView/ReportMgr/Crystal/nls/fr-be/NumberParameterEditor':function(){
define('Sage/MainView/ReportMgr/Crystal/nls/fr-be/NumberParameterEditor',{});
},
...
'Sage/MainView/ReportMgr/Crystal/nls/fr-be/CrystalReportConditionEditor':function(){
define('Sage/MainView/ReportMgr/Crystal/nls/fr-be/CrystalReportConditionEditor',{});
},
...
'Sage/Library/nls/fr-be/DocumentProperties':function(){
define('Sage/Library/nls/fr-be/DocumentProperties',{});
},
...
'Sage/MainView/ReportMgr/nls/fr-be/HistoryListPanelConfig':function(){
define('Sage/MainView/ReportMgr/nls/fr-be/HistoryListPanelConfig',{});
},
...
'Sage/MainView/ReportMgr/Crystal/nls/fr-be/BooleanParameterEditor':function(){
define('Sage/MainView/ReportMgr/Crystal/nls/fr-be/BooleanParameterEditor',{});
},
...
'Sage/TaskPane/nls/fr-be/ContactTasksTasklet':function(){
define('Sage/TaskPane/nls/fr-be/ContactTasksTasklet',{});
},
...
'Sage/MainView/ReportMgr/Common/nls/fr-be/_WizardDialogBase':function(){
define('Sage/MainView/ReportMgr/Common/nls/fr-be/_WizardDialogBase',{});
},
...
'Sage/MainView/JobMgr/nls/fr-be/SchedulesListPanelConfig':function(){
define('Sage/MainView/JobMgr/nls/fr-be/SchedulesListPanelConfig',{});
},
...
'Sage/MainView/ReportMgr/nls/fr-be/ReportsListPanelConfig':function(){
define('Sage/MainView/ReportMgr/nls/fr-be/ReportsListPanelConfig',{});
},
...
'Sage/UI/Alarms/nls/fr-be/JobNotificationButton':function(){
define('Sage/UI/Alarms/nls/fr-be/JobNotificationButton',{});
},
'Sage/MainView/ReportMgr/Crystal/nls/fr/CrystalReportWizardController':function(){
define(
    "Sage/MainView/ReportMgr/Crystal/nls/fr/CrystalReportWizardController", ({
...
'Sage/MainView/ReportMgr/Crystal/nls/fr-be/CrystalReportWizardController':function(){
define('Sage/MainView/ReportMgr/Crystal/nls/fr-be/CrystalReportWizardController',{});
},
...
'Sage/MainView/JobMgr/nls/fr-be/JobDefinitionsListPanelConfig':function(){
define('Sage/MainView/JobMgr/nls/fr-be/JobDefinitionsListPanelConfig',{});
},
...
'Sage/MainView/ReportMgr/Crystal/nls/fr-be/CrystalReportsUtility':function(){
define('Sage/MainView/ReportMgr/Crystal/nls/fr-be/CrystalReportsUtility',{});
},
...
'Sage/MainView/ReportMgr/Crystal/nls/fr-be/DateRangeParameterEditor':function(){
define('Sage/MainView/ReportMgr/Crystal/nls/fr-be/DateRangeParameterEditor',{});
},
...
'Sage/MainView/ReportMgr/nls/fr-be/BaseListPanelConfig':function(){
define('Sage/MainView/ReportMgr/nls/fr-be/BaseListPanelConfig',{});
},
...
'Sage/MainView/ReportMgr/Crystal/nls/fr-be/DateParameterEditor':function(){
define('Sage/MainView/ReportMgr/Crystal/nls/fr-be/DateParameterEditor',{});
},
...
'Sage/Library/nls/fr-be/FolderHandler':function(){
define('Sage/Library/nls/fr-be/FolderHandler',{});
},
...
'Sage/MainView/IntegrationContract/nls/fr-be/SalesQuoteRTDV':function(){
define('Sage/MainView/IntegrationContract/nls/fr-be/SalesQuoteRTDV',{});
},
...
'Sage/MainView/ReportMgr/nls/fr-be/ReportManagerUtility':function(){
define('Sage/MainView/ReportMgr/nls/fr-be/ReportManagerUtility',{});
},
...
define("Sage/TaskPane/nls/fr/ReportManagerTasksTasklet", (
{ taskRunReport_Caption: 'Exécuter le rapport',
...
'Sage/TaskPane/nls/fr-be/ReportManagerTasksTasklet':function(){
define('Sage/TaskPane/nls/fr-be/ReportManagerTasksTasklet',{});
},
...
'Sage/MainView/JobMgr/nls/fr-be/JobManagerGroupContextService':function(){
define('Sage/MainView/JobMgr/nls/fr-be/JobManagerGroupContextService',{});
},
...
'Sage/TaskPane/nls/fr-be/JobManagerTasksTasklet':function(){
define('Sage/TaskPane/nls/fr-be/JobManagerTasksTasklet',{});
},
...
'Sage/MainView/ActivityMgr/nls/fr-be/ActivityEditorAttendeesTab':function(){
define('Sage/MainView/ActivityMgr/nls/fr-be/ActivityEditorAttendeesTab',{});
},
...
'Sage/Utility/nls/fr-be/Jobs':function(){
define('Sage/Utility/nls/fr-be/Jobs',{});
},
...
'Sage/UI/Alarms/nls/fr-be/JobNotificationPopup':function(){
define('Sage/UI/Alarms/nls/fr-be/JobNotificationPopup',{});
},
...
'Sage/MainView/ActivityMgr/AttendeeLookup/nls/fr-be/LeadLookupConfig':function(){
define('Sage/MainView/ActivityMgr/AttendeeLookup/nls/fr-be/LeadLookupConfig',{});
},
...
'Sage/MainView/ReportMgr/nls/fr-be/SchedulesListPanelConfig':function(){
define('Sage/MainView/ReportMgr/nls/fr-be/SchedulesListPanelConfig',{});
},
...
'Sage/MainView/ReportMgr/nls/fr-be/ReportManagerGroupContextService':function(){
define('Sage/MainView/ReportMgr/nls/fr-be/ReportManagerGroupContextService',{});
},
...
define('Sage/MainView/ReportMgr/Crystal/nls/fr-be/StringParameterEditor',{});
},
...
'Sage/Services/nls/fr-be/ReportingService':function(){
define('Sage/Services/nls/fr-be/ReportingService',{});
},
...
'Sage/MainView/ActivityMgr/nls/fr-be/HistoryEditorAttendeesTab':function(){
define('Sage/MainView/ActivityMgr/nls/fr-be/HistoryEditorAttendeesTab',{});
},
...
'Sage/Reporting/nls/fr-be/Enumerations':function(){
define('Sage/Reporting/nls/fr-be/Enumerations',{});
},
...
'Sage/MainView/ReportMgr/Crystal/nls/fr-be/CrystalReportConditionsDialog':function(){
define('Sage/MainView/ReportMgr/Crystal/nls/fr-be/CrystalReportConditionsDialog',{});
},
...
'Sage/Extensions/Activity/ListPanelOverrides/nls/fr-be/ActivityListPanelConfig':function(){
define('Sage/Extensions/Activity/ListPanelOverrides/nls/fr-be/ActivityListPanelConfig',{});
},
...
'Sage/UI/nls/fr-be/JobSchedulingWidget':function(){
define('Sage/UI/nls/fr-be/JobSchedulingWidget',{});
},
...
'Sage/MainView/ReportMgr/Crystal/nls/fr-be/MultiselectStringParameterEditor':function(){
define('Sage/MainView/ReportMgr/Crystal/nls/fr-be/MultiselectStringParameterEditor',{});
},
...
'Sage/MainView/ReportMgr/nls/fr-be/ReportManagerActions':function(){
define('Sage/MainView/ReportMgr/nls/fr-be/ReportManagerActions',{});
},
...
'Sage/MainView/Contact/nls/fr-be/ContactUserAssociationEditor':function(){
define('Sage/MainView/Contact/nls/fr-be/ContactUserAssociationEditor',{});
},
...
'Sage/MainView/JobMgr/nls/fr-be/BaseListPanelConfig':function(){
define('Sage/MainView/JobMgr/nls/fr-be/BaseListPanelConfig',{});
},
