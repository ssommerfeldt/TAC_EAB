define("Sage/Groups/nls/GroupManager", {
    root: {
        ...
        createAdHocGroupJob_Description: 'Group: ${0}',
        createAdHocGroupJob_Title: 'Creating Group',
        createAdHocGroupJobError: 'Sorry an error occurred during the creation of the group: ${0}',
        createAdHocGroupJobProcessingJobMsg: 'You may continue waiting for completion, or you may close this message.  You will receive a notification when the group is complete.',
    },
    "de": true,
    "en": true,
    "fr": true,
