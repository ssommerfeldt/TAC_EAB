...
<script runat="server">
    ...
    private void Application_End(object sender, EventArgs e)
    {
        try
        {
            ...
            Log.WarnEx(string.Format("The SData for Customer Portal application has shutdown for the following reason: Reason={0}; Message={1}; Stack Trace={2}", shutDownReason, shutDownMessage, shutDownStack), EventIds.AdHocEvents.WarnApplicationEnd);
        }
        catch (Exception ex)
        {
    ...
    private void Application_Error(object sender, EventArgs e)
    {
        ...
        catch (Exception ex)
        {
            ...
            Log.Error(ErrorHelper.AppendSlxErrorId("SalesLogix SData Portal unhandled exception", sSlxErrorId), fullException);
        }
    }
